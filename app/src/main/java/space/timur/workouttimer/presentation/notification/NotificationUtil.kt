package space.timur.workouttimer.presentation.notification
...
class NotificationUtil {
    companion object {
        ...
        fun showTimerExpired(context: Context){
            ...
            val nBuilder = getBasicNotificationBuilder(context, Constants.CHANNEL_ID_TIMER, true)
            ...
            nManager.createNotificationChannel(Constants.CHANNEL_ID_TIMER, Constants.CHANNEL_NAME_TIMER, true)

            nManager.notify(Constants.TIMER_ID, nBuilder.build())
        }
        ...
        fun hideTimerNotification(context: Context){
            val nManager = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
            nManager.cancel(Constants.TIMER_ID)
        }
